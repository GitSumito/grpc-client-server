...
func (x *ListFilesRespnse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListFilesRespnse) ProtoMessage() {}

func (x *ListFilesRespnse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_file_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListFilesRespnse.ProtoReflect.Descriptor instead.
func (*ListFilesRespnse) Descriptor() ([]byte, []int) {
	return file_proto_file_proto_rawDescGZIP(), []int{1}
}

func (x *ListFilesRespnse) GetFilenames() []string {
	if x != nil {
		return x.Filenames
	}
	return nil
...
var file_proto_file_proto_rawDesc = []byte{
	...
	0x4c, 0x69, 0x73, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6e, 0x73, 0x65,
	0x12, 0x1c, 0x0a, 0x09, 0x66, 0x69, 0x6c, 0x65, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x09, 0x66, 0x69, 0x6c, 0x65, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x32, 0x4b,
	0x0a, 0x0c, 0x46, 0x69, 0x6c, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x3b,
	...
	0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x46,
	0x69, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6e, 0x73, 0x65, 0x42, 0x06, 0x5a, 0x04, 0x2e,
...
var file_proto_file_proto_goTypes = []interface{}{
	...
	(*ListFilesRespnse)(nil), // 1: file.ListFilesRespnse
}
var file_proto_file_proto_depIdxs = []int32{
	0, // 0: file.FileServices.ListFiles:input_type -> file.ListFilesRequest
	1, // 1: file.FileServices.ListFiles:output_type -> file.ListFilesRespnse
